 ...
 *
 */
public class Wanglong91 {
	
	private static final SimpleDateFormat SDF = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private static final Logger logger = LoggerFactory.getLogger(Wanglong91.class);
	...
	public static ScriptResult func(Object[] parameters) {
		...
		logger.info("91 post charge content:{}", request);
		...
		if ( "S".equals(orderStatus) ) {
			...
			if ( user == null ) {
				logger.warn("Failed to find user by : callbackInfo{}, rolename:{}", callbackInfo, userName);
			...
			BILLING_LOGGER.info("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}", new Object[]{
					userName, "", transtime, 0, 0, "unknown", 0, 0, 0, boughtYuanbao, failedDesc});
		}
