					...
					if ( user == null ) {
						...
						if ( userSessionKey != null ) {
							...
							if ( GameContext.getInstance().getGameServerId().equals(gameServerId) )  {
								ChargeManager.getInstance().doCharge(userSessionKey, user, transid, null, money, "legend", true);									
							} else {
								...
								bceCharge.setChannel("legend");
								GameContext.getInstance().proxyToRemoteGameServer(userSessionKey, gameServerId, bceCharge.build());
							}
						} else {
							ChargeManager.getInstance().doCharge(null, user, transid, null, money, "legend", true);
						}
					}
				} else {
					BILLING_LOGGER.info("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}", new Object[]{
