 ...
 *
 */
public class Xinqihd {
	
	private static final SimpleDateFormat SDF = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private static final Logger logger = LoggerFactory.getLogger(Xinqihd.class);
	...
	public static ScriptResult func(Object[] parameters) {
		...
		String jsonData = (String)paramMap.get("transdata");
					...
					if ( user == null ) {
						...
						if ( userSessionKey != null ) {
							...
							if ( GameContext.getInstance().getGameServerId().equals(gameServerId) )  {
								ChargeManager.getInstance().doCharge(userSessionKey, user, transid, null, money, "xinqihd", true);									
							} else {
								...
								bceCharge.setChannel("xinqihd");
								GameContext.getInstance().proxyToRemoteGameServer(userSessionKey, gameServerId, bceCharge.build());
							}
						} else {
							ChargeManager.getInstance().doCharge(null, user, transid, null, money, "xinqihd", true);
						}
					}
				} else {
					BILLING_LOGGER.info("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}", new Object[]{
