...
public class Kupai {
	...
	private static final Logger logger = LoggerFactory.getLogger(Kupai.class);
	...
	public static ScriptResult func(Object[] parameters) {
		...
		logger.info("kupai post charge content:{}", request);
		...
		if ( chargeResult == 0 ) {
			if ( feetype == 2 ) {
				if ( transtype == 0 ) {
					...
					if ( user == null ) {
						logger.warn("Failed to find user by exorderno: {}", userIdStr);
						BILLING_LOGGER.info("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}", new Object[]{
								userIdStr, "", transtime, 0, 0, "unknown", 0, 0, 0, boughtYuanbao, 
								StringUtil.concat(new Object[]{"not found user:", userIdStr})});
					} else {
						success = true;
						...
						if ( userSessionKey != null ) {
							...
							if ( GameContext.getInstance().getGameServerId().equals(gameServerId) )  {
								ChargeManager.getInstance().doCharge(userSessionKey, user, transid, null, money, "kupai", true);									
							} else {
			...
			BILLING_LOGGER.info("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}", new Object[]{
					userIdStr, "", transtime, 0, 0, "chargeresult", 0, 0, 0, boughtYuanbao, 
