...
public class WavFile {
	...
	private boolean wordAlignAdjust; // Specify if an extra byte at the end of the
																		// data chunk is required for word alignment
	...
	public static WavFile newWavFile(File file, int numChannels, long numFrames,
		...
		putLE(averageBytesPerSecond, wavFile.buffer, 16, 4); // Average Bytes Per
																													// Second
