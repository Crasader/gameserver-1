 ...
 *
 */
public class YeepayCharge {

	private static final Logger logger = LoggerFactory.getLogger(YeepayCharge.class);
	...
	public static final HttpMessage chargeNotify(HttpMessage httpMessage, String variable) {
		...
		if ( success ) {
			ScriptResult result = ScriptManager.getInstance().runScript(ScriptHook.CHARGE_YEEPAY, content);
