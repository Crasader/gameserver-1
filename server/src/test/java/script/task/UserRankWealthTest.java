...
public class UserRankWealthTest {
	...
	public void test() throws Exception {
		...
		RankManager.getInstance().clearUserSpecificData(username);
		
		TaskPojo task = new TaskPojo();
		//2000 yuanbao
		task.setId("10000");
		task.setStep(1);
		task.setScript(ScriptHook.TASK_USER_RANK_WEALTH.getHook());
