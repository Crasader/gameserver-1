 ...
 * 
 */
public class TaskShopPanel extends AbstractTaskPanel {

	private static TaskShopPanel instance = new TaskShopPanel();

	public TaskShopPanel() {
		init();
	}

	public static TaskShopPanel getInstance() {
		return instance;
	}
