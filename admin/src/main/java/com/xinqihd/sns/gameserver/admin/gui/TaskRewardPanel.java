 ...
 *
 */
public class TaskRewardPanel extends AbstractTaskPanel {
	
	private static TaskRewardPanel instance = new TaskRewardPanel(); 
	
	
	public TaskRewardPanel() {
		init();
	}
	
	public static TaskRewardPanel getInstance() {
		return instance;
	}

	public void init() {
		//创建工作区域
		String collection = "rewards";
