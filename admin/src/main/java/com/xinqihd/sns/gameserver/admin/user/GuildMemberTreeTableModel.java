...
public class GuildMemberTreeTableModel extends DefaultTreeTableModel {
	
	private static final Logger logger = LoggerFactory.getLogger(GuildMemberTreeTableModel.class);
