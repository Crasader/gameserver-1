...
public class GuildBagTreeTableModel extends DefaultTreeTableModel {
	
	private static final Logger logger = LoggerFactory.getLogger(GuildBagTreeTableModel.class);
