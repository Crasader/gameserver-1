...
import com.xinqihd.sns.gameserver.admin.data.ShopDataPricePrintService;
 ...
 *
 */
public class TaskShopDataGeneratorPanel extends MyPanel implements ActionListener {
	
	private static final String COMMAND_PRINT_PRICE = "printPrice";
	...
	private static TaskShopDataGeneratorPanel instance = new TaskShopDataGeneratorPanel(); 
	...
	private JXButton printPriceButton = new JXButton("输出商品数据");
	...
	public TaskShopDataGeneratorPanel() {
		init();
	}
	
	public static TaskShopDataGeneratorPanel getInstance() {
		return instance;
	}
	...
	public void actionPerformed(ActionEvent e) {
		if ( COMMAND_PRINT_PRICE.equals(e.getActionCommand()) ) {
			ShopDataPriceConfig config = parsePriceConfig();
			
			ShopDataPricePrintService service = new ShopDataPricePrintService(model, config);
...
//				}
				...
				frame.add(TaskShopDataGeneratorPanel.getInstance());
