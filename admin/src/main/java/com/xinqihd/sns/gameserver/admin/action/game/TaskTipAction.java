...
public class TaskTipAction extends AbstractAction {
	
	public TaskTipAction() {
		super("游戏提示数据设定", ImageUtil.createImageSmallIcon("Pen.png", "游戏提示数据设定"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		SwingUtilities.invokeLater(new Runnable(){
			public void run() {
				MainPanel.getInstance().setCenterPanel(TaskTipPanel.getInstance());
			}
		});
	}
